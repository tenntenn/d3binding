...
this.unbind=function(){a.remove(this);return this};this.notify=function(a){var e=d(b),i=a[a.length-1];Object.keys(e).forEach(function(b){var d=c[b];c.hasOwnProperty(b)&&"function"===typeof d&&i!==d&&d.notify(a,e[b])});return this}},Observable:function(a,b){var c=function(a){void 0!==a&&c.notify([],a);return b};c.notify=function(d,g){0>d.lastIndexOf(c)&&(b=g,a.notify(d.concat(c),c))};c.prototype=sb.Observable;this.property=c}};
...
arguments[0].prototype===sb.Observable?(b={observable:arguments[0]},c={},d=function(b){g(b.observable);return{}}):(b=arguments[0],c=arguments[0],d=arguments[1])):(b=arguments[0],c=arguments[1]):2<arguments.length&&(b=arguments[0],c=arguments[1],d=arguments[2]);return new sb.Binding(a,b,c,d)};sb.observable=function(b){return(new sb.Observable(a,b)).property}})();var d3binding={};d3binding.expandable=function(a){"function"!==typeof a&&(a=function(){});var b=function(){a.apply(b,arguments)};b.expand=function(c){var d=a;a=function(){d.apply(b,arguments);c.apply(b,arguments)};return b};return b};d3binding.binding=function(){var a=d3binding.expandable(function(){});a.isTransition=!1;a.transition=function(){if(!a.isTransition){var b=d3binding.expandable(a);for(key in a)a.hasOwnProperty(key)&&(b[key]=a[key]);b.isTransition=!0;return b}return a};var b=function(b,a,g,e){b.expand(function(i){i[e](a,function(i){var j=d3.select(this),f=g;if("function"===typeof f&&(f=f(i),f.prototype===sb.Observable)){var h=f;sb.bindding(h,function(){if(b.isTransition)if(null!==a)j.transition()[e](a,h());else j.transition()[e](h());
else if(null!==a)j[e](a,h());else j[e](h())}).bind();f=h()}return f})});return b};a.attr=function(a,d){return b(this,a,d,"attr")};a.style=function(a,d){return b(this,a,d,"style")};a.classed=function(a,d){return b(this,a,d,"classed")};a.text=function(a){return b(this,null,a,"text")};a.html=function(a){return b(this,null,a,"classed")};return a};
