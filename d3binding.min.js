...
c.observable()&&b.push(c.observable());d.observable()&&b.push(d.observable());e.observable()&&b.push(e.observable());f.observable()&&b.push(f.observable());g.observable()&&b.push(g.observable());return b.join(" ")}).bind();b.translate=function(c,d){sb.isObservable(c)&&sb.isObservable(d)&&(a.observable=sb.observable(""),a.binding=sb.binding(a.observable,c,d).compute(a.observable,function(){return"translate("+c()+","+d()+")"}).bind());return b};b.scale=function(a,d){sb.isObservable(a)&&sb.isObservable(d)&&
(c.observable=sb.observable(""),c.binding=sb.binding(c.observable,a,d).compute(c.observable,function(){return"scale("+a()+","+d()+")"}).bind());return b};b.rotate=function(a,c,e){sb.isObservable(a)&&(d.observable=sb.observable(""),d.binding=sb.isObservable(e)&&sb.isObservable(c)?sb.binding(d.observable,a,c,e).compute(d.observable,function(){return"rotate("+a()+","+c()+","+e()+")"}).bind():sb.binding(d.observable,a).compute(b,function(){return"rotate("+a()+")"}).bind());return b};b.skewX=function(a){sb.isObservable(a)&&
(e.observable=sb.observable(""),e.binding=sb.binding(e.observable,a).compute(e.observable,function(){return"skewX("+a()+")"}).bind());return b};b.skewY=function(a){sb.isObservable(a)&&(f.observable=sb.observable(""),f.binding=sb.binding(f.observable,a).compute(f.observable,function(){return"skewY("+a()+")"}).bind());return b};b.matrix=function(a,c,d,e,f,l){sb.isObservable(a)&&(sb.isObservable(c)&&sb.isObservable(d)&&sb.isObservable(e)&&sb.isObservable(f)&&sb.isObservable(f))&&(g.observable=sb.observable(""),
g.binding=sb.binding(g.observable,a,c,d,e,f,l).compute(g.observable,function(){return"matrix("+a()+","+c()+","+d()+","+e()+","+f()+","+l()+")"}).bind());return b};return b}})();
